-- Fix archive_completed_task trigger to reference columns that actually exist
-- template_id was removed in migration 016, due_date was replaced with start_date/end_date in 017
